Yn.RefreshScrollerView = Yn.ScrollerView.extend({
  ...
  hasNext: true,
    ...
    return !this.get('isRefreshed')  &&  this.get('hasNext') && this.get('length') > 0 && this.get('isAtBottom');

	}).property('isAtBottom', 'isRefreshed', 'hasNext', 'length'),
  ...
  touchMove: function(event) {
    console.log('touchMove... checking');
		this._check();
	},

	_check: function() {

		if ( this.get('hasNext') && this.get('length') > 0 ) {

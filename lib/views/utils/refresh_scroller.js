Yn.RefreshScrollerView = Em.View.extend( Yn.ContextManager, Yn.Scroller, {
  ...
  touchMove: function(event) {
	...
	_check: function() {
      ...
      console.log(this._inner.offset().top);
      console.log(this._offsetTop);
      console.log(this._innerOuterHeight);
  ...
  _showBottomViewChanged: Em.observer(function() {
    ...
    if ( this.get('showBottomView') ) {
      ...
      if ( !this._endTimeout ) {
        console.log( 'holdPeriod ' +this.holdPeriod );
      ...
      console.log('showBottomViewChanged');

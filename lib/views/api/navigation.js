...
Yn.NavigationView = Em.ContainerView.extend({
  ...
  didInsertStackChild: function(view){
    ...
    // bug: didInsertElement get triggerd twice for some weird reason
    if ( !view.navigatedDidInsertElementFired ) {
      ...
      if ( !this.views.contains( view ) ) {
        ...
        this._move(true, true);
      }

    }
  },

  pushView: function(newView, backState, transitionCallback) {

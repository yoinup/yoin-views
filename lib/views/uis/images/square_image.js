...
Yn.SquareImageView = Em.ContainerView.extend({
  ...
  child: Em.View.extend({
    ...
    classNameBindings: ['isUp','isDown'],

    isUpBinding: Em.Binding.oneWay('parentView.isUp'),
    isDownBinding: Em.Binding.oneWay('parentView.isDown')
  ...
  setBackgroundImage: function() {
    ...
    if ( !!content ) {
      ...
      if ( type === Yn.Brand ) {
        ...
        src = content.get('showPhoto');
        //src = 'http://flickholdr.com/48/48/jayz/bw';

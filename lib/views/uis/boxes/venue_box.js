...
Yn.VenueBoxView = Em.View.extend({
  ...
  didInsertElement: function() {
    // TODO: this can be included in a new CSS script at startup
    var width = this.$().width();
    var height = width*0.5;

    var elems$ = this.$('> .venue-box-products, > .venue-box-products > .venue-box-products-swipe, > .venue-box-products > .venue-box-products-swipe > .venue-product');
    elems$.height(height);
